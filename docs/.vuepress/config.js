...
module.exports = {
  ...
  themeConfig: {
    ...
    // 博主信息，显示在首页侧边栏
    blogger: {
      avatar: 'https://elite-file.oss-cn-shanghai.aliyuncs.com/avatar/2020/11/30/avatar.png',
      name: 'MoXi',
      slogan: '后端界的Java小白',
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '后端博客,个人技术博客,后端开发,后端框架,Java前端,后端面试题,技术文档,学习,面试,JavaSE,Jvm,Spring,SpringBoot,SpringCloud,Dubbo,Zookeeper,RabbitMq,Kafka,Clickhouse,Mysql,Redis,github,markdown',
      },
    ],
