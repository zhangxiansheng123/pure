...
主题的配置在`.vuepress/config.js`文件的`themeConfig`字段中，是在原有配置的基础上新增或修改的配置，配置示例请查看：[config.js](https://github.com/zhangxiansheng123/vuepress-theme-vdoing/blob/master/docs/.vuepress/config.js)。
